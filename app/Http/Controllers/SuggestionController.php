...
class SuggestionController extends Controller
{
    ...
    public function editSuggestion(Request $request){
        ...
        try{
            ...
            return redirect('/usulan-saya/')->with('status','Data usulan baru berhasil disimpan');
        }catch (\PDOException $e) {
            return redirect('/usulan-saya/')->with('error', 'Gagal menambah data usulan buku, silahkan coba lagi');
        }
    }
