...
<div class="container-fluid p-0 mb-5">
    <div class="owl-carousel header-carousel position-relative">
        <div class="owl-carousel-item position-relative">
            <img class="img-fluid" src="{{asset('images/carolus_beranda.jpg')}}" alt="">
            <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(24, 29, 56, .7);">
                <div class="container">
                    <div class="row justify-content-start">
                        <div class="col-sm-10 col-lg-8">
                            <h5 class="text-primary text-uppercase mb-3 animated slideInDown">Selamat Datang di</h5>
                            <h1 class="display-3 text-white animated slideInDown">Website Perpustakaan SMA Carolus Surabaya</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="owl-carousel-item position-relative">
            ...
            <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(24, 29, 56, .7);">
                <div class="container">
                    <div class="row justify-content-start">
                        <div class="col-sm-10 col-lg-8">
                            <h5 class="text-primary text-uppercase mb-3 animated slideInDown">Panduan Penggunaan Website</h5>
                            <h1 class="display-3 text-white animated slideInDown">Website Perpustakaan SMA Carolus Surabaya</h1>
                            <p class="fs-5 text-white mb-4 pb-2">Pastikan Anda sudah memiliki akun untuk masuk di website. Jika belum memiliki akun, silahkan datang ke petugas perpustakaan untuk membuat akun</p>
                        </div>
                    </div>
                </div>
            </div>
